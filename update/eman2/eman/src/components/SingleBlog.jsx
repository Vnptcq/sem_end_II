  ...
  return (
    ...
    <div className="sidebar-post">
      ...
      <div className="single_popular">
        ...
        <h5>
          <a href="single_blog.html">Supercharging Your SEO Game with AI Writing Assistants</a>
        </h5>
      </div>
      <div className="single_popular">
        <a href="single_blog.html">
        ...
        <h5>
          <a href="single_blog.html">AI Writing Assistants and the Future of Content Marketing</a>
        </h5>
      </div>
      <div className="single_popular">
        <a href="single_blog.html">
        ...
        <h5>
          <a href="single_blog.html">Enhancing Your E-commerce Store With AI Writing Assistants</a>
        </h5>
      </div>
      <div className="single_popular">
        <a href="single_blog.html">
        ...
        <h5>
          <a href="single_blog.html">Building your content strategy cannot get easier than this</a>
        </h5>
      </div>
      <div className="single_popular">
        <a href="single_blog.html">
        ...
        <h5>
          <a href="single_blog.html">This is the only read you would need before sitting down to prepare</a>
        </h5>
      </div>
    </div>
