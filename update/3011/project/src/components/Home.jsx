...
const Home = () => {
  return (
	...
	<section id="home" className="home_bg"
		style={{backgroundImage: 'url(assets/images/banner/home.png)',  backgroundSize:'cover', backgroundPosition: 'center center'}}>
			...
			<div className="row">
				...
				<div className="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
					...
					<div className="ab_content">
						...
						<p>Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod tempor
							incididunt ut labore et simply.</p>
					</div>
					<div className="abmv">
			...
			<div className="row">
				<div className="col-lg-12 text-center">
					...
					<div className="partner">
						<a href="#"><img src={client} alt="image"/></a>
						<a href="#"><img src={client} alt="image"/></a>
						<a href="#"><img src={client} alt="image"/></a>
						<a href="#"><img src={client} alt="image"/></a>
						<a href="#"><img src={client} alt="image"/></a>
	...
	<section className="marketing_content_area section-padding">
		<div className="container">
			...
			<div className="row">
				...
				<div className="col-lg-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s"
					data-wow-offset="0">
					<div className="single_feature_one">
						<div className="sf_top">
				...
				<div className="col-lg-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s"
					data-wow-offset="0">
					<div className="single_feature_one">
						<div className="sf_top">
				...
				<div className="col-lg-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s"
					data-wow-offset="0">
					<div className="single_feature_one">
						<div className="sf_top">
			...
			<div className="row">
				<div className="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
					...
					<div className="single-team-home">
						<div className="img"><img src={team1} className="img-fluid" alt=""/></div>
				...
				<div className="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"
					data-wow-offset="0">
					<div className="single-team-home">
						<div className="img"><img src={team2} className="img-fluid" alt=""/></div>
						<div className="team-content-home">
				...
				<div className="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s"
					data-wow-offset="0">
					<div className="single-team-home">
						<div className="img"><img src={team3} className="img-fluid" alt=""/></div>
						<div className="team-content-home">
							<h3>Mark Linomi</h3>
							<p>Marketer</p>
							<div className="sth_det">
				...
				<div className="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s"
					data-wow-offset="0">
					<div className="single-team-home">
						<div className="img"><img src={team4} className="img-fluid" alt=""/></div>
						<div className="team-content-home">
							<h3>Amira Yerden</h3>
							<p>UI/UX Designer</p>
							<div className="sth_det">
